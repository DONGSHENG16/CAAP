 ...
 * @version 1.0
 */
public class Minimap2_BuiltIndex extends ConnectLinuxCon {
    @Test
    public void Minimap2setIndex(String toolPath, String reference_genome){

        String command = "cd "+toolPath+";" +
                "/usr/bin/time -v minimap2 -d genInd/genome.mmi 00ref/"+reference_genome+" 2> minimap2_index_log.txt";
