<template>
  <div class="featurecounts-container">
    <h1>FeatureCounts Construct Expression Matrix</h1>
...
export default {
  ...
  methods: {
    submitForm() {
      axios.post('http://localhost:9090/expMatrix/featurecounts', this.form)
        .then(response => {
