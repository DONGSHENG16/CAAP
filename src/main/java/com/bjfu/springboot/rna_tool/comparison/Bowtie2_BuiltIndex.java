 ...
 * @version 1.0
 */
public class Bowtie2_BuiltIndex extends ConnectLinuxCon {
    @Test
    public void Bowtie2setIndex(String toolPath, String reference_genome){

        AnalyzeFile analyzeFile = new AnalyzeFile();
        String command = "cd "+toolPath+";" +
                "/usr/bin/time -v bowtie2-build 00ref/"+reference_genome+" genInd/genome_index 2> bowtie2_index_log.txt";
        System.out.println("Bowtie2, starting to build index");
