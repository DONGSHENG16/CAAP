...
<!--      <el-input style="width: 200px" placeholder="Please enter address" suffix-icon="el-icon-position" class="ml-5" v-model="address"></el-input>-->
    ...
    <div style="margin: 10px 0">
      <el-button type="primary" @click="handleAdd">Add New <i class="el-icon-circle-plus-outline"></i></el-button>
      <el-popconfirm
          class="ml-5"
          confirm-button-text='Confirm'
          cancel-button-text='Let me think'
          icon="el-icon-info"
          icon-color="red"
          title="Are you sure you want to bulk delete this data?"
          @confirm="delBatch"
      >
